function hesapla(){
    ...
    if(vki<18.5){
        ...
        document.getElementById("çerceve").style.left = "31px";
        document.getElementById("çerceve").style.visibility = "visible";

    }
    else if(vki<24.9){
        document.getElementById("sonuc").innerHTML = vki.toFixed(2);
        document.getElementById("çerceve").style.left = "89px";
        document.getElementById("çerceve").style.visibility = "visible";
        ...
        document.getElementById("sonuc").innerHTML = vki.toFixed(2);
        document.getElementById("çerceve").style.left = "146px";
        document.getElementById("çerceve").style.visibility = "visible";
        ...
        document.getElementById("sonuc").innerHTML = vki.toFixed(2);
        document.getElementById("çerceve").style.left = "203px";
        document.getElementById("çerceve").style.visibility = "visible";
